export const Locator = {
  ...
  settingsToolbar: '[aria-label="Settings"]',
  singleStreamingChannelToggle: 'input[name="isSingleChannelMode"]',
  defaultFederationTypeDropdown: 'select[name="defaultFederationType"]',
  ...
  gisShowMarkersToggle: '//div[text()="Location Markers"]/..//input[@type="checkbox"]',
  ...
  gisFederatedFirstOutlineItem: '(//div[text()="Federated"]/following::div[contains(@class,"IafSubHeader-module_list-item-sub-title")])[1]',
  gisFederatedOutlineListItems: '//div[contains(@class,"IafSubHeader-module_list-item-sub-title") and (text()="IPUT Exchange" or text()="IKON")]',
